        ...
        <div class="row">
            <div class="col-md-4 order-md-2 mb-4">
                ...
                <ul class="list-group mb-3">
                    <li class="list-group-item d-flex justify-content-between lh-condensed checkout-li"
                    ...
                    <li class="list-group-item d-flex justify-content-between checkout-li"
                        style="padding: 0px 0px 0px 0px;">
                        <table>
                            <tr>
                                <td>Totaal</td>
                ...
                <form class="needs-validation" novalidate action="betalen.php" method="POST">
                    <div class="row">
                        <div class="col-md-12 mb-8">
                            ...
                            <input type="text" name="naam" class="form-control" id="Voornaam"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="adres" class="form-control" id="Adres"
                               value="<?php echo $_SESSION['Adres']; ?>" required>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="gemeente" class="form-control" id="Gemeente"
...
<!--                                  required onchange=button("vak1",this.cvcstatus)>-->
                    ...
                    <button name="betalen" style="background-color: red; border-color: red "
                            class="btn btn-primary btn-lg btn-block" type="submit">Betalen
                    </button>
                </form>
            </div>
        </div>

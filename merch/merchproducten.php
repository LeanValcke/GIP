                        ...
                        if ($Merch['GameID'] == $_GET['GameID']) {
                            {
                                ...
                                <div class="col-sm-6 col-md-4" style="float:left; ">
                                    <div class="card mb-4 shadow-sm" style="margin-bottom:0px;">
                                        ...
                                        <img class="my-webshop-img bd-placeholder-img card-img-top" width="400"
                                             height="400"
                                        ...
                                        <div class="card-body">
                                                ...
                                                <strong>
                                                    <a style="color:black;"
                                                       href="<?php echo(SITE_URL); ?>/merch/merchpagina.php?ProductID=<?php echo $Merch['ProductID'] ?>">
                                                        <?php echo $Merch['Merchnaam'] ?> </a></strong>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <a class="btn btn-warning btn-sm" role="button"
                                                           ...
                                                           href="<?php echo SITE_URL; ?>/winkelkar/toevoegen.php?ProductID=<?php echo $Merch["ProductID"] ?>">
                                                            <i><img id="shoppinglogo"
                                                                    src="<?php echo SITE_URL; ?>/img/Navbar/winkelkarretje.png"
                                                ...
                                                <h3>
                                                    <span class="badge badge-dark">&euro; <?php echo $Merch['ProductPrijs'] ?></span>
                                                </h3>
                                            </div>
                                        </div>
                                    </div>

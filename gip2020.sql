...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 12 apr 2020 om 15:02
-- Serverversie: 5.7.9
-- PHP-versie: 5.6.16
...
(1, '20', 20, 'Fortnite', 'Fortnite Trainingsbroek', 1, 'Merch/FortniteBroekZwart.png', 'Dit kan jouw nieuwe Fortnite trainingsbroek zijn! Deze broek is enkel beschikbaar in het zwart en bestaat uit 80% katoen en 20% polyester.'),
(2, '25', 20, 'Overwatch', 'Overwatch Game', 2, 'Merch/OverwatchGame.jpg', 'Ga de strijd aan op toekomstige slagvelden en kies je held uit een reeks soldaten, wetenschappers, avonturiers en schepsels van allerlei pluimage. Manipuleer de tijd, tart de zwaartekracht en ontketen ijzingwekkende krachten en wapens.'),
...
(5, '10', 10, 'CSGO', 'CSGO Trui', 5, 'Merch/CSGOtrui.png', 'Dit kan jouw nieuwe CS:GO trui zijn! Deze trui bevat  een Hyper Beast print uit de game zelf! Deze trui bevat ook een kap en bestaat volledig uit polyester.'),
...
(10, '12', 10, 'Fortnite', 'Fortnite Boekentas', 1, 'Merch/FortniteDansBoekentas.png', 'Wil je graag naar school gaan met een nieuwe Fortnite boekentas? Dan kan deze boekentas jou misschien overtuigen! Deze boekentas bevat 1 compartiment en een voorzak.'),
(11, '30', 5, 'Fortnite', 'Fortnite T-shirt ', 1, 'Merch/FortniteTshirtRood.png', 'Dit kan jouw nieuwe Fortnite t-shirt zijn! Deze t-shirt is enkel beschikbaar in het rood en bestaat uit 100% katoen.'),
(21, '25', 10, 'Overwatch', 'Overwatch T-shirt ', 2, 'Merch/OverwatchTshirtZwart.png', 'Dit kan jouw nieuwe Overwatch t-shirt zijn! Deze t-shirt is enkel beschikbaar in het zwart en bestaat uit 100% katoen.'),
(22, '20', 10, 'Overwatch', 'Brigitte Funkopop', 2, 'Merch/OverwatchBrigitteFunkopop.png', 'Deze leuke Overwatch Bridgitte Funko Pop figuur is ongeveer 9 cm groot en komt verpakt in een window display box.\n'),
(23, '40', 20, 'GTA V', 'GTA V Trui ', 3, 'Merch/GTAVTrui.png\r\n', 'Dit kan jouw nieuwe GTA V trui zijn! Deze trui is enkel beschikbaar in het zwart. Deze trui bevat een kap en een zak aan de voorkant. De trui bestaat volledig uit katoen.'),
(24, '15', 30, 'GTA V', 'GTA V T-shirt', 3, 'Merch/GTAVshirt.png\n', 'Heb jij altijd al een t-shirt gewild van GTA V? Dan kan deze t-shirt jou misschien overtuigen!'),
(25, '25', 15, 'Minecraft', 'Minecraft T-shirt ', 4, 'Merch/MinecraftTshirtGroen.png', 'Sta jij bekend als de persoon die veel dood gaat in Minecraft? Dan is deze t-shirt perfect voor jou! Deze t-shirt bestaat uit 100% katoen en is enkel beschikbaar in het groen.'),
(26, '15', 15, 'Minecraft', 'Minecraft Muts ', 4, 'Merch/MinecraftMutsGroen.png', 'De nieuwe warme Minecraft muts beschermt je tegen koud weer en wind. Niemand heeft zo een muts als jij.'),
(27, '15', 25, 'CSGO', 'CSGO Tanktop ', 5, 'Merch/CSGOTanktopZwart.png', 'Dit kan jouw nieuwe CS:GO tanktop zijn! Deze tanktop is enkel beschikbaar in het zwart en bestaat uit 100% katoen.'),
...
(29, '50', 10, 'Assassins Creed', 'Assassins Creed Jas Blauw', 6, 'Merch/AssassinsCreedJasBlauw.png', 'Dit kan jouw nieuwe Assassin''s Creed jas zijn! Deze jas is enkel beschikbaar in het zwart met blauw en bestaat uit 60% katoen en 40% polyester.'),
(30, '45', 30, 'Assassins Creed', 'Assassins Creed Jas Grijs', 6, 'Merch/AssassinsCreedJasZwart.png', 'Dit kan jouw nieuwe Assassin''s Creed jas zijn! Deze jas is enkel beschikbaar in het grijs met donkergrijs en gouden details en bestaat uit 60% katoen en 40% polyester.\n'),
(31, '50', 50, 'Watch Dogs 2', 'Watch Dogs 2 Trui Zwart', 7, 'Merch/WatchDogs2Truizwart.png', 'Dit kan jouw nieuwe Watch Dogs trui zijn! Deze trui bevat een kap en een zak aan de voorkant. De trui bestaat uit 100% katoen.\n'),
(32, '55', 10, 'Watch Dogs 2', 'Watch Dogs 2 Trui', 7, 'Merch/WatchDogs2Trui.png', 'Dit kan jouw nieuwe Watch Dogs trui zijn! Deze trui bevat geen kap en bestaat uit 100% katoen.'),
(33, '15', 20, 'Call of Duty: Black ops', 'COD Mok ', 8, 'Merch/CODMokZwart.png', 'Heb jij altijd al een mok gewild van Call of Duty? Dan kan deze mok jou misschien overtuigen!'),
(34, '25', 20, 'Call of Duty: Black ops', 'COD T-shirt ', 8, 'Merch/CODTshirtZwart.png', 'Dit kan jouw nieuwe Call of Duty t-shirt zijn! Deze t-shirt is enkel beschikbaar in het zwart en bestaat uit 100% katoen.'),
(35, '25', 20, 'Mortal Kombat', 'Mortal Kombat T-shirt', 9, 'Merch/MortalKombattshirtgeel.png', 'Dit kan jouw nieuwe Mortal Kombat t-shirt zijn! Deze t-shirt is enkel beschikbaar in het geel met zwarte en grijze details. Deze t-shirt bestaat uit 100% katoen.\n'),
(36, '15', 20, 'Mortal Kombat', 'Mortal Kombat Mok ', 9, 'Merch/MortalKombatmokzwart.png', 'Heb jij altijd al een mok gewild van Mortal Kombat X? Dan kan deze mok jou misschien overtuigen!'),
